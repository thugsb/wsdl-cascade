...
$(function() {
  ...
  $('.event-form').append('<div class="tag-section calendar"><label><input checked="checked" type="radio" name="calendar" value="Campus Events"/>Campus Events</label><label><input type="radio" name="calendar" value="Events Open to Public"/>Events Open to Public</label></div>');
