...
function pagetest($child) {
  if ($child->path->path != 'index' && preg_match('/^morr[a-z]/',$child->path->path))
    return true;
}
...
$data = array (
  'site://slc-catalogue-undergraduate/clusters/africana-studies/index' => 'Africana Studies','site://slc-catalogue-undergraduate/clusters/design-studies/index' => 'Design Studies','site://slc-catalogue-undergraduate/clusters/ethnic-and-diasporic-studies/index' => 'Ethnic and Diasporic Studies','site://slc-catalogue-undergraduate/clusters/global-studies/index' => 'Global Studies','site://slc-catalogue-undergraduate/clusters/international-studies/index' => 'International Studies','site://slc-catalogue-undergraduate/clusters/latin-american-and-latinoa-studies/index' => 'Latin American and Latino/a Studies','site://slc-catalogue-undergraduate/clusters/lesbian-gay-bisexual-and-transgender-studies/index' => 'Lesbian, Gay, Bisexual, and Transgender Studies','site://slc-catalogue-undergraduate/clusters/pre-health-program/index' => 'Pre-health','site://slc-catalogue-undergraduate/clusters/womens-studies/index' => "Women's Studies",
