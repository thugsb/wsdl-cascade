...
$title = 'Copy Config Sets into wwww_archived';
...
$asset_children_type = 'pageConfigurationSetContainer';
...
function editPage($client, $auth, $asset) {
  ...
  if ($changed == true) {
    ...
    if ($_POST['action'] == 'edit') {
      $copy = $client->copy ( array ('authentication' => $auth, 'identifier' => array('type' => 'pageconfigurationsetcontainer', 'id' => $asset['id']), 'copyParameters' => array('newName'=> $asset['name'], 'destinationContainerIdentifier' => array('id' => 'a17481e97f0000026531294208d520c7', type => 'pageconfigurationsetcontainer'), 'doWorkflow'=>false) ) );
    }
